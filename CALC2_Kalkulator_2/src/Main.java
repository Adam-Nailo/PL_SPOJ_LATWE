    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < dane.size(); i++) {
            ...
            switch (informacje[i][0].charAt(0)){
                case ('z'):
                    memory[Integer.parseInt(informacje[i][1])]=Integer.parseInt(informacje[i][2]);
                    break;
                case ('+'):
                    System.out.println(memory[Integer.parseInt(informacje[i][1])]+memory[Integer.parseInt(informacje[i][2])]);
                    break;
                case ('-'):
                    System.out.println(memory[Integer.parseInt(informacje[i][1])]-memory[Integer.parseInt(informacje[i][2])]);
                    break;
